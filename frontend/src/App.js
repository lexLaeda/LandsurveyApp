          ...
          <div className="container">
            <div className="panel panel-default">
              ...
              <div className="panel-body">
                  <button type="button" className="btn btn-dark" data-toggle="modal" data-target="#addNewPoint">Add new</button>
              </div>
            </div>
          </div>
          <div className="modal fade" id="addNewPoint" tabIndex="-1" role="dialog" aria-labelledby="exampleModalLabel"
               aria-hidden="true">
